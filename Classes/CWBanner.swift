...
public protocol CWBannerDelegate: AnyObject {
...
public protocol CWBannerPageControl where Self: UIView {
    /// 当前下标
...
public class CWBanner: UIView {
    //MARK: - 构造方法
    public init(frame: CGRect, flowLayout: CWSwiftFlowLayout, delegate: CWBannerDelegate) {
...
//        let rect = self.bounds
        ...
        b.decelerationRate = UIScrollView.DecelerationRate(rawValue: 0.0)
...
public extension CWBanner {
    ...
    /// - Returns: 业务层对应的下标
    public func caculateIndex(indexPath: IndexPath) -> Int {
    ...
    public func scrollToIndexPathAnimated(_ indexPath: IndexPath) {
